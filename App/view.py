...
while True:
    ...
    if int(inputs[0]) == 1:
        ...
        sort = 5
        answer = views_country_category(catalog['Videos'],country,num_countries,category,sort)
        print("Tiempo [ms]: ", f"{answer[0]:.3f}", "  ||  ",
              "Memoria [kB]: ", f"{answer[1]:.3f}")

    elif int(inputs[0]) == 3:
        country = input("Ingrese el pais en el que desea buscar: ")
        answer = trending_country(catalog['Videos'],country)
        print("Tiempo [ms]: ", f"{answer[0]:.3f}", "  ||  ",
              "Memoria [kB]: ", f"{answer[1]:.3f}")

    elif int(inputs[0]) == 4:
        category = input("Ingrese la categoria en la que desea buscar: ")
        answwer = trending_category(catalog['Videos'],category)
        print("Tiempo [ms]: ", f"{answer[0]:.3f}", "  ||  ",
              "Memoria [kB]: ", f"{answer[1]:.3f}")
